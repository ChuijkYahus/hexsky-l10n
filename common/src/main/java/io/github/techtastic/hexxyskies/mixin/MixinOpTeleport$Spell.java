...
public class MixinOpTeleport$Spell {
    ...
    @WrapOperation(method = "cast(Lat/petrak/hexcasting/api/casting/eval/CastingEnvironment;)V", at = @At(value = "INVOKE_ASSIGN", target = "Lnet/minecraft/world/phys/Vec3;length()D"))
    private double hexxyskies$modifyDistance(Vec3 instance, Operation<Double> original, @Local CastingEnvironment env) {
